...
Find your tech-setup repository in [our course github organization](https://github.com/soc333-sum23). You should see the list of files in the repository, and your commit message should show up next to the .qmd and .html files. If you click on these files, you should see that you are listed as the author.
